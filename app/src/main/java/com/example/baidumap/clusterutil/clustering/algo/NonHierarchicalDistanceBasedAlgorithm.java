...
import com.example.baidumap.clusterutil.projection.Bounds;
...
import com.example.baidumap.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final HashMap<QuadItem<T>, StaticCluster<T>> itemToCluster =
